...
{
    public class WinPredictorServiceSequentialTests
    {

        [Fact]
        public async void WinPredictorServiceSequential_When_Zero_Games()
        {
        ...
        [InlineData(10000)]
        [InlineData(1000000)]
        public async void WinPredictorServiceSequential_When_N_Games_With_SwitchDoor(int numberOfGames)
        {
        ...
        [InlineData(10000)]
        [InlineData(1000000)]
        public async void WinPredictorServiceSequential_When_N_Games_With_NO_SwitchDoor(int numberOfGames)
        {
            var winStrategyService = new MontyHallWinStrategyService();
            var winPredictorServiceInstance = new WinPredictorServiceSequential(winStrategyService);
